...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        <a class="navbar-brand" href="/fcsdm/home">Welcome To SDM Football Club.</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="/fcsdm/members">회원 목록</a>
                </li>
                <li>
                    <a href="#">회비<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/fcsdm/memberships">회비 납부이력</a>
                        </li>
                        <li>
                            <a href="/fcsdm/transactions">수입/지출내역</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                <li>
                    <a href="/fcsdm/games/records">경기결과</a>
                </li>
                <li>
                    <a href="#">관리자<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="/fcsdm/memberships/form">회비 납부정보 입력</a>
                        </li>
                        <li>
                            <a href="/fcsdm/transactions/form">수입/지출내역 입력</a>
                        </li>
                        <li>
                            <a href="/fcsdm/games/records/form">경기결과 입력</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>                
